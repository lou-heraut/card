...
|---|---|---|---|---|---|
| [ETPA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Evapotranspiration/ETPA.yaml) | ETPA | Cumul des évapotranspirations annuelles | mm | ETP |  |

## Flow / Baseflow / criteria

| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [BFI-Wal](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/BFI-Wal.yaml) | BFI-Wal | Indice de débit de base | without unit | Q |  |
...
| [delta-BFI-LH_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/delta-BFI-LH_H.yaml) | delta-BFI-LH_H1, delta-BFI-LH_H2, delta-BFI-LH_H3 | Changement de l'indice de débit de base entre l'horizon proche et la période historique (Lyne et Hollick) | without unit | Q |  |
| [delta-BFI-Wal_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/delta-BFI-Wal_H.yaml) | delta-BFI-Wal_H1, delta-BFI-Wal_H2, delta-BFI-Wal_H3 | Changement de l'indice de débit de base entre l'horizon proche et la période historique (Wallingford) | without unit | Q |  |
...
| [median-centerBF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/median-centerBF.yaml) | median-centerBF | Médiane du centre des écoulements lents | yearday | Q |  |
| [median-dtBF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/median-dtBF.yaml) | median-dtBF | Médiane de la durée des écoulements lents | day | Q |  |
| [median-endBF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/median-endBF.yaml) | median-endBF | Médiane de la fin des écoulements lents | yearday | Q |  |
| [median-startBF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/median-startBF.yaml) | median-startBF | Médiane du début des écoulements lents | yearday | Q |  |
| [median-vBF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Baseflow/criteria/median-vBF.yaml) | median-vBF | Médiane du volume annuel généré par les écoulements lents | hm^{3} | Q |  |
...
| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [Q10](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/Q10.yaml) | Q10 | Débit dépassé 1 an sur 10 | m^{3}.s^{-1} | Q |  |
...
| [alpha-QJXA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/alpha-QJXA.yaml) | alpha-QJXA, hyp-alpha-QJXA | Pente de Sen et résultat du test de Mann-Kendall calculés sur la série des débits journaliers maximaux annuels QJXA | m^{3}.s^{-1}.year^{-1} | Q |  |
| [delta-Q01A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-Q01A_H.yaml) | delta-Q01A_H1, delta-Q01A_H2, delta-Q01A_H3 | Changement moyen du débit annuel dépassé 1 année sur 100 entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q05A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-Q05A_H.yaml) | delta-Q05A_H1, delta-Q05A_H2, delta-Q05A_H3 | Changement moyen du débit annuel dépassé 1 année sur 20 entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q10A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-Q10A_H.yaml) | delta-Q10A_H1, delta-Q10A_H2, delta-Q10A_H3 | Changement moyen du débit annuel dépassé 1 année sur 10 entre l'horizon proche et la période historique | % | Q |  |
...
| [delta-fQ01A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-fQ01A_H.yaml) | delta-fQ01A_H1, delta-fQ01A_H2, delta-fQ01A_H3 | Changement moyen de la fréquence annuelle de dépassement du Q01 entre l'horizon proche et la période historique | day.year^{-1} | Q |  |
| [delta-fQ05A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-fQ05A_H.yaml) | delta-fQ05A_H1, delta-fQ05A_H2, delta-fQ05A_H3 | Changement moyen de la fréquence annuelle de dépassement du Q05 entre l'horizon proche et la période historique | day.year^{-1} | Q |  |
| [delta-fQ10A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/delta-fQ10A_H.yaml) | delta-fQ10A_H1, delta-fQ10A_H2, delta-fQ10A_H3 | Changement moyen de la fréquence annuelle de dépassement du Q10 entre l'horizon proche et la période historique | day.year^{-1} | Q |  |
...
| [median-dtFlood](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/median-dtFlood.yaml) | median-dtFlood | Durée médiane des crues | day | Q |  |
| [median-tQJXA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/criteria/median-tQJXA.yaml) | median-tQJXA | Médiane des dates du débit journalier maximal annuel | yearday | Q |  |
...
| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [Q01A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/Q01A.yaml) | Q01A | Débit annuel dépassé 1 année sur 100 | m^{3}.s^{-1} | Q |  |
| [Q05A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/Q05A.yaml) | Q05A | Débit annuel dépassé 1 année sur 20 | m^{3}.s^{-1} | Q |  |
| [Q10A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/Q10A.yaml) | Q10A | Débit annuel dépassé 1 année sur 10 | m^{3}.s^{-1} | Q |  |
...
| [fQ01A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/fQ01A.yaml) | fQ01A | Fréquence annuelle de dépassement du Q01 | day.year^{-1} | Q |  |
| [fQ05A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/fQ05A.yaml) | fQ05A | Fréquence annuelle de dépassement du Q05 | day.year^{-1} | Q |  |
| [fQ10A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/High_Flows/serie/fQ10A.yaml) | fQ10A | Fréquence annuelle de dépassement du Q10 | day.year^{-1} | Q |  |
...
| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [Q90](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/Q90.yaml) | Q90 | Débit dépassé 9 années sur 10 | m^{3}.s^{-1} | Q |  |
...
| [alpha-VCN10](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/alpha-VCN10.yaml) | alpha-VCN10, hyp-alpha-VCN10 | Pente de Sen et résultat du test de Mann-Kendall calculés sur la série des minimums annuels des débits moyens sur 10 jours VCN10 | m^{3}.s^{-1}.year^{-1} | Q |  |
| [delta-Q90A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/delta-Q90A_H.yaml) | delta-Q90A_H1, delta-Q90A_H2, delta-Q90A_H3 | Changement moyen du débit annuel dépassé 9 années sur 10 entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q95A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/delta-Q95A_H.yaml) | delta-Q95A_H1, delta-Q95A_H2, delta-Q95A_H3 | Changement moyen du débit annuel dépassé 19 années sur 20 entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q99A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/delta-Q99A_H.yaml) | delta-Q99A_H1, delta-Q99A_H2, delta-Q99A_H3 | Changement moyen du débit annuel dépassé 99 années sur 100 entre l'horizon proche et la période historique | % | Q |  |
...
| [median-allLF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-allLF.yaml) | median-startLF, median-centerLF, median-endLF, median-dtLF, median-vLF | Médiane du début des basses eaux | yearday | Q |  |
| [median-dtLF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-dtLF.yaml) | median-dtLF | Médiane de la durée des basses eaux | day | Q |  |
| [median-finLF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-finLF.yaml) | median-endLF | Médiane de la fin des basses eaux | yearday | Q |  |
| [median-startLF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-startLF.yaml) | median-startLF | Médiane du début des basses eaux | yearday | Q |  |
| [median-tVCN10](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-tVCN10.yaml) | median-tVCN10 | Médiane des dates du minimum annuel des débits moyens sur 10 jours | yearday | Q |  |
| [median-vLF](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/median-vLF.yaml) | median-vLF | Médiane des volumes de déficit des basses eaux | hm^{3} | Q |  |
| [n-VCN10-5_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/criteria/n-VCN10-5_H.yaml) | n-VCN10-5_H1, n-VCN10-5_H2, n-VCN10-5_H3 | Nombre d'années de l'horizon {horizon} où le VCN10 est supérieur au VCN10-5 de la période historique | without unit | Q |  |

## Flow / Low Flows / serie

| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [Q90A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/serie/Q90A.yaml) | Q90A | Débit annuel dépassé 9 années sur 10 | m^{3}.s^{-1} | Q |  |
| [Q95A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/serie/Q95A.yaml) | Q95A | Débit annuel dépassé 19 années sur 20 | m^{3}.s^{-1} | Q |  |
| [Q99A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows/serie/Q99A.yaml) | Q99A | Débit annuel dépassé 99 années sur 100 | m^{3}.s^{-1} | Q |  |
...
| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [delta-QMNA_winter_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows_Winter/criteria/delta-QMNA_winter_H.yaml) | delta-QMNA_winter_H1, delta-QMNA_winter_H2, delta-QMNA_winter_H3 | Changement moyen du minimum hivernal des débits mensuels entre l'horizon {horizon} et la période historique | % | Q |  |
| [delta-QNA_winter_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Low_Flows_Winter/criteria/delta-QNA_winter_H.yaml) | delta-QNA_winter_H1, delta-QNA_winter_H2, delta-QNA_winter_H3 | Changement moyen du minimum hivernal du débit journalier entre l'horizon {horizon} et la période historique | % | Q |  |
...
| fiche | variable(s) | nom | unité | entrées | exp. |
|---|---|---|---|---|---|
| [Q50](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/Q50.yaml) | Q50 | Médiane des débits | m^{3}.s^{-1} | Q |  |
...
| [alpha-QA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/alpha-QA.yaml) | alpha-QA, hyp-alpha-QA | Pente de Sen et résultat du test de Mann-Kendall calculés sur la série des moyennes annuelles des débits journaliers | m^{3}.s^{-1}.year^{-1} | Q |  |
| [delta-Q25A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/delta-Q25A_H.yaml) | delta-Q25A_H1, delta-Q25A_H2, delta-Q25A_H3 | Changement moyen du troisième quartile des débits annuels entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q50A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/delta-Q50A_H.yaml) | delta-Q50A_H1, delta-Q50A_H2, delta-Q50A_H3 | Changement moyen de la médiane des débits annuels entre l'horizon proche et la période historique | % | Q |  |
| [delta-Q75A_H](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/delta-Q75A_H.yaml) | delta-Q75A_H1, delta-Q75A_H2, delta-Q75A_H3 | Changement moyen du premier quartile des débits annuels entre l'horizon proche et la période historique | % | Q |  |
...
| [mean-QA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/criteria/mean-QA.yaml) | mean-QA | Moyenne des moyennes annuelles du débit journalier | m^{3}.s^{-1} | Q |  |
...
| [Q25A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/Q25A.yaml) | Q25A | Troisième quartile des débits annuels | m^{3}.s^{-1} | Q |  |
| [Q50A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/Q50A.yaml) | Q50A | Médiane des débits annuels | m^{3}.s^{-1} | Q |  |
| [Q75A](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/Q75A.yaml) | Q75A | Premier quartile des débits annuels | m^{3}.s^{-1} | Q |  |
...
| [QJC10](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/QJC10.yaml) | QJC10 | Débit moyen mensuel moyenné sur 10 jours | m^{3}.s^{-1} | Q |  |
...
| [QSA_JJASO](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/QSA_JJASO.yaml) | QSA_JJASO | Moyenne saisonnière annuelle du débit journalier | m^{3}.s^{-1} | Q |  |
...
| [median-QJC5](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Mean_Flows/serie/median-QJC5.yaml) | median-QJC5 | Moyenne mobile sur 5 jours du débit médian inter-annuel | m^{3}.s^{-1} | Q |  |
...
| [STD](https://github.com/lou-heraut/card/blob/main/src/card/cards/Flow/Performance/STD.yaml) | STD | Écart-type des données journalières | m^{3}.s^{-1} | Q_obs, Q_sim |  |
...
| [RA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/RA.yaml) | RA | Cumul des précipitations totales annuelles | mm | R |  |
| [RA_all](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/RA_all.yaml) | RA | Précipitation annuelle | mm | R, Rl, Rs |  |
| [RA_ratio](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/RA_ratio.yaml) | RA_ratio | Ratio des précipitations | without unit | R, Rl, Rs |  |
| [RAl](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/RAl.yaml) | RAl | Cumul des précipitations liquides annuelles | mm | Rl |  |
...
| [RAs](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/RAs.yaml) | RAs | Cumul des précipitations solides annuelles | mm | Rs |  |
...
| [mean-RA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/mean-RA.yaml) | mean-RA | Moyenne des cumuls des précipitations totales annuelles | mm | R |  |
| [mean-RSA_season](https://github.com/lou-heraut/card/blob/main/src/card/cards/Precipitations/mean-RSA_season.yaml) | mean-RA_DJF, mean-RA_MAM, mean-RA_JJA, mean-RA_SON | Moyenne des précipitations totales de chaque hiver | mm | R |  |
...
| [Rc](https://github.com/lou-heraut/card/blob/main/src/card/cards/Sensitivity_to_Climate_Variability/Rc.yaml) | Rc | Coefficient de ruissellement | m^{3}.s^{-1}.mm^{-1} | Q, R |  |
...
| [mean-TA](https://github.com/lou-heraut/card/blob/main/src/card/cards/Temperature/mean-TA.yaml) | mean-TA | Moyenne des températures moyennes annuelles | °C | T |  |
| [mean-TSA_season](https://github.com/lou-heraut/card/blob/main/src/card/cards/Temperature/mean-TSA_season.yaml) | mean-TSA_DJF, mean-TSA_MAM, mean-TSA_JJA, mean-TSA_SON | Moyenne des températures de chaque hiver | °C | T |  |
